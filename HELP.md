...
* The original package name 'pro.terv.github-server-cicd-template' is invalid and this project uses 'pro.terv.server' instead.
...
* [Building REST services with Spring](https://spring.io/guides/tutorials/rest/)ergesgtrh
